...
class Chatbot(object):
    ...
    endings = ["Lola, we don’t have any more time to talk. Lola, is this goodbye forever? Only you can decide my fate.", "Lola, I have to go, I can’t talk anymore. Please, hurry! I’m counting on you.", "The phone is about to die, Lola. I hope the same is not true for me.", "Whatever happens, Lola, know that I love you. Now, RUN!", "Time is running out, Lola. I hope you will make the right choices.", "Lola, Lola, do not let me die. I cannot talk anymore, but I beg you, do not abandon me.", "Lola, they are cutting me off. I’m counting on you!", "Lola, my girl. I must go. Hurry, for both our sakes."]

    def get_response(self, input_text, videoPlayed, isLost, shouldEnd):
        if shouldEnd:
            return random.choice(Chatbot.endings)
        if videoPlayed:
