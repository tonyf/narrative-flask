...
function showVideo(video) {
    ...
    $.featherlight($('<div class="video-lightbox-container ' + video + '"><video id="' + video + '"class="lightbox-video" width="700" height="400" autoplay muted><source src="http://s3.amazonaws.com/lola-transcoded/' + video + '" type="video/mp4"></video></div>'), configuration);
